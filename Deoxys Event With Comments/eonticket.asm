...
NormanScriptStart:
	...
	setwildbattle $19A, $1E, $001
		   ...
		   callasm $2028E3B; these addresses worked for blisy, but almost certainly won't work
		
		   callasm $2028E57 ; for me because they might be somehwere else in ram
